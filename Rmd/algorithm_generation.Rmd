...
```{r}
g1 + geom_vline(xintercept =9,size = 2) + geom_vline(xintercept =16, size = 2) 
```
...
g2 = g2 + geom_line(color = "orangered", size = 3) + theme_bw() + ggtitle("Peak Time Analysis") + geom_vline(xintercept =12,size = 2) + geom_vline(xintercept =16, size = 2) 
g2
```
...
g2 = g2 + geom_line(color = "steelblue", size = 3) + theme_bw() + ggtitle("Peak Time Analysis") + geom_vline(xintercept =6,size = 2) + geom_vline(xintercept =12, size = 2) 
g2
```
